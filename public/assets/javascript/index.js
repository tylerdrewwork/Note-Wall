    ...
    function addNotesToPage() {
        ...
        function displayNotes() {
            ...
            // $("#note-wall-container").append(`<div class="wallnote"></div>`);
                $("#note-wall-container").append(`<img class="wallnote" data-note-id=${randomNotes[i].id} text-note-id="${randomNotes[i].text}" views-note-id=${randomNotes[i].views} src="assets/svg/sticky_note.svg" alt="note" onclick="showNote()"></img>`);           
                }
            }); 
        }
        displayNotes();
