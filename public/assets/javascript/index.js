    ...
    function addNotesToPage() {
        ...
        function displayNotes() {
            ...
            // $("#note-wall-container").append(`<div class="wallnote"></div>`);
                $("#note-wall-container").append(`<img class="wallnote" data-note-id=${randomNotes[i].id} data-note-text="${randomNotes[i].text}" data-note-views=${randomNotes[i].views} src="assets/svg/sticky_note.svg" alt="note" onclick="showNote()"></img>`);           
                }
            }); 
        }
        displayNotes();
...
function showNote() {
    ...
    // need to show text in modal here?
